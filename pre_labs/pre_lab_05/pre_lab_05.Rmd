...
##No they are different in a lot of ways.
...
##It says it's joining it by the county.
...
## Prince George's county had the highest population of 18+ African Americans. The percentage of Democrats was 78%, which is also one of the highest in Maryland.
...
##Howard County has the highest percentage of 18+ year old Asians. There is 52% of Democrats in that county, which is significantly less than the previous comparison of PG County and Democrats.
...
##It is a DBL column, aka a value. Which is not what we want.
