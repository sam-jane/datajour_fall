...
**Task** Run the following code to load data. Describe what you see in the answer space below. What columns exist in this data? **Answer** It shows the precinct, the congress, the council, etc.
...
**Task** Run the following code. Describe the output in the space below: what kind of information does it contain? **Answer** It holds the type of different precincts and where the voting places are for the people in Maryland. Tells you how the precinct ID, name, geometric dimensions, polling id, etc.
...
It broke up the precincts with borders. And gave a horizontal and vertical axis
...
**Task** Run the following code. Describe the output in the space below. **Answer**
# The code looks much cleaner, it has the state on the x axis. It zooms in on the Maryland state, but the axis is a weird angle.
```{r}
md_counties |>
  ggplot() +
  geom_sf() +
...
**Task** Run the following code. Describe the output in the space below. **Answer**
#This is a zoomed out and it has way more borders. 
...
**Task** Run the following code. Describe the output in the space below. **Answer**
#This is showing us the amount of voters who have voted in PG county, and also how those voters are voting.
...
**Task** Run the following code. Describe the output in the space below. **Answer**
#This added the school and precinct from where the voters voted.
```{r}
...
**Task** Run the following code. Describe the output in the space below. **Answer**
#This added a color code that showed how many people voted in each precincts.
...
**Task** Run the following code. Describe the output in the space below. **Answer**
#This is the vote total that has each of the voters based on the county
...
**Task** Run the following code. Describe the output in the space below. **Answer** 
#This is showing the estimated population
...
**Task** Run the following code. Describe the output in the space below. **Answer**
#Adding the geographic code and more counties
...
**Task** Run the following code. Describe the output in the space below. **Answer**
#Organizing the voters by the county
```{r}
md_county_population
...
**Task** Run the following code. Describe the output in the space below. **Answer**
#This is adding the population wtih the county and cleaning up the names
...
**Task** Run the following code. Describe the output in the space below. **Answer**
#This is joining the vote totals by every 10,000 voters
...
**Task** Run the following code. Describe the output in the space below. **Answer** 
#It's removing the NA values, particularly any misspellings
...
**Task** Run the following code. Describe the output in the space below. **Answer**
#Arranging the voters by parties for every 10,000 people. These are showing it by county in Maryland.
...
**Task** Run the following code. Describe the output in the space below. **Answer**
#This does the counted voters by every 10,000 people in Maryland counties.
...
**Task** Run the following code. Describe the output in the space below. **Answer**
#This just changed the colors from blue to make it more fine-tuned
...
**Task** Run the following code. Describe the output in the space below. **Answer**
#This added it for the unaffilated voters
...
#This is the unaffilated voters. Interesting to see that Maryland's biggest counties don't have a ton of unaffilated voters
