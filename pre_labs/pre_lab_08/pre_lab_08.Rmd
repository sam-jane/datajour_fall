...
**Task** Run the following code to load the data. In the space below, indicate how many rows and columns it has. It has 24 rows and 18 columns
...
**Answer** The first is creating a different column that takes the unaffiliated voters from 2024 - the unaffiliated voters from 2022. Then it's arranging those voters into counties and ordering it by the top amount of unaffiliated voters.
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer** A blank space (shoutout T Swift)
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer**: A basic, but unorganized bar plot.
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer** We've organized the bars into a descending order. It looks much more organized.
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer** We flipped it from a vertical to a horizontal bar chart.
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer** It looks more visually pleasing
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last version of the chart? **Answer** it has a blue background now
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer** The axis's columns now have names and a title.
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer** There's dates that show the number of contributors
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer** Now it's a line chart of those contributors and dates.
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer** They gave it week labels.
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer** Spaced out the x axis so that it's readable
