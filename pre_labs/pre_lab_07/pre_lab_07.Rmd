...
```{r echo=FALSE}
#census_api_key("d5d7b2d93dc399cd129e8880f9e9bf4b363cb8f8", install=TRUE)
```
...
Is the difference between Calvert and Montgomery significant? **Answer** No because the margin of error for Montgomery is much smaller than the margin of error for Calvert. That makes it hard to conclude that the difference is signficant.

Is the difference between Howard and everyone else significant? **Answer** yes, because Howards margin of error still is wider than the next county.
...
**Answer** Zipcodes 20912 and 21202 both have median household incomes of less than $50,000.
...
Why is the top zip codes total so low, but the median average income so high?
