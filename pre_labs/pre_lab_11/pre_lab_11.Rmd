...
##Its just the raw totals and does not include the percentage compared to the Republicans. The column name for the Democrats is also a little long and sloppy.
...
##They are probably refferring to coincide with where the numbers were on the ballott.
...
##There is 20 tags of UL in code
...
##This is giving each list link a text headline to them.
...
##They have now have the title and the links attached to them
